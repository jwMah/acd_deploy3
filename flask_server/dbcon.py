...
#     except:
#         return 'Error occured inserting'
...
#         return my_connection.session.query(models.img_upload.imgdir).all()
    
#     except:
#         return 'Error occured reading'
...
#         return my_connection.session.query(models.img_upload).count()
    
#     except:
#         return 'Error occured counting'
